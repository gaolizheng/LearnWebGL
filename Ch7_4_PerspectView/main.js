...
function main() {
    ...
    if (u_ProjMatrix == null) {
        console.error("can't find u_ProjMatrix");
        return;
    }
...
function draw(gl, n, u_MVMatrix, matrix) {
    matrix.setLookAt(eyeX, eyeY, eyeZ, 0, 0, -100, 0, 1, 0);
